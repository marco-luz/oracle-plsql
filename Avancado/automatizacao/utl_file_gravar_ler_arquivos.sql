...
-- Criar o diretorio 'C:\ARQUIVOS_TESTE' no Windows
-- Conectar como SYS

CREATE OR REPLACE DIRECTORY ARQUIVOS_TESTE AS 'C:\ARQUIVOS_TESTE';

GRANT READ, WRITE ON DIRECTORY ARQUIVOS_TESTE TO hr;
...
DECLARE
    ...
    FROM   employees;
BEGIN
    vfile := UTL_FILE.FOPEN('ARQUIVOS_TESTE', 'employees.txt','w',32767);
...
BEGIN
    vfile := UTL_FILE.FOPEN('ARQUIVOS_TESTE', 'employees.txt','r',32767);
    LOOP
